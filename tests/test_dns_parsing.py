...
class TestCheckVpnDnsUsage:
    ...
    def test_not_using_vpn_dns(self):
    ...
    def test_multiple_vpn_dns(self):
...
class TestIntegration:
    ...
    def test_realistic_interface_output(self):
...
MulticastDNS setting: no
  ...
  Current DNS Server: 8.8.8.8
    ...
    def test_realistic_vpn_output(self):
  ...
  Current DNS Server: 10.2.0.1
    ...
    def test_realistic_global_section(self):
...
Link 2 (eth0)
    ...
    def test_secure_vpn_workflow(self):
    ...
    def test_public_dns_workflow(self):
